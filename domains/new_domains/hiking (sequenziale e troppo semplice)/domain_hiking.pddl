...
(:action put_down
         ...
         :effect (and (down ?x3)(not (up ?x3)) (increase (total-cost) 1))
)

(:action put_up
         :parameters ( ?x1 - person ?x2 - place ?x3 - tent)
         :precondition (and (at_person ?x1 ?x2)(at_tent ?x3 ?x2)(down ?x3))
         :effect (and (up ?x3)(not (down ?x3))(increase (total-cost) 1))
)
...
(:action drive_passenger
         ...
         (at_car ?x4 ?x3)(not (at_car ?x4 ?x2))(at_person ?x5 ?x3)
         (not (at_person ?x5 ?x2))(increase (total-cost) 1))
)

(:action drive
         :parameters ( ?x1 - person ?x2 - place ?x3 - place ?x4 - car)
         :precondition (and (at_person ?x1 ?x2)(at_car ?x4 ?x2))
         :effect (and (at_person ?x1 ?x3)(not (at_person ?x1 ?x2))(at_car ?x4 ?x3)
...
(:action drive_tent
         ...
         (at_tent ?x5 ?x3)(not (at_tent ?x5 ?x2))(increase (total-cost) 1))
)
...
(:action drive_tent_passenger
         ...
         :effect (and (at_person ?x1 ?x3)(not (at_person ?x1 ?x2))(at_car ?x4 ?x3)(not (at_car ?x4 ?x2))
         (at_tent ?x5 ?x3)(not (at_tent ?x5 ?x2))(at_person ?x6 ?x3)
         (not (at_person ?x6 ?x2))(increase (total-cost) 1))
)
...
(:action walk_together
         ...
         :effect (and (at_person ?x3 ?x2)(not (at_person ?x3 ?x4))(at_person ?x5 ?x2)(not (at_person ?x5 ?x4))
         (walked ?x6 ?x2)(not (walked ?x6 ?x4))(increase (total-cost) 1))
)
