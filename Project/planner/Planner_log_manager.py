...
class Planner_Log_Manager:
    ...
    def generate_log_file(self, i, p_failed, plans_dir_path, t, avg_time, min_time, max_time, median_time, std_dev):
        """
        ...
        with open(log_file_path, 'w') as log_file:
            ...
            log_file.write(f"Time required to generate plans: {t:.2f} seconds\n")
            log_file.write("\n ----- Times for planning -----\n")
