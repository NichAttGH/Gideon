...
def update_h_progress(progress_path, h_progress):
    """
    Save current progress into the 'progress.txt' file.
    
    Writes the current number of generated hashes to the progress file.
    
    Args:
        h_progress (int): Current number of problems generated
    """
    ...
    for l, line in enumerate(lines):
        if line.startswith("hash_list_progress = "):
            ...
            lines[l] = f"hash_list_progress = {h_progress}\n"
            break
