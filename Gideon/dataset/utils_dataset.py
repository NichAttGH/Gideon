...
def final_output(log_data, train_set, val_set, test_set):
    ...
    print(tabulate(log_data, headers="keys", tablefmt="grid", colalign=("center", "center", "center")))
...
def generate_log(logs_dir, log_data, train_set, val_set, test_set):
    ...
    with open(log_file_path, 'w') as log_file:
        log_file.write(tabulate(log_data, headers="keys", tablefmt="grid", colalign=("center", "center", "center")))
        log_file.write("\n")
